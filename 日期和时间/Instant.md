...
public class myInstant {
    public static void main(String[] args) {
        ...
        System.out.println(now.getEpochSecond()); // 秒    1678430168
        System.out.println(now.toEpochMilli());  // 毫秒    1678430168746
    }
}
```
...
public class myInstant {
    public static void main(String[] args) {
        ...
        // 那么，给它附加上一个时区，就可以创建出ZonedDateTime：
        ZonedDateTime zdt  = now.atZone(ZoneId.systemDefault());
        System.out.println(zdt); // 2023-03-10T14:37:45.557241+08:00[Asia/Shanghai]
    }
}
