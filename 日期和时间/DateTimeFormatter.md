...
public class myDateTimeFormatter {
    public static void main(String[] args) {
        ...
        System.out.println(formatter.format(zdt)); // 2023-03-10T14:32 GMT+08:00

        var zhFormatter = DateTimeFormatter.ofPattern("yyyy MMM dd EE HH:mm", Locale.CHINA);
        System.out.println(zhFormatter.format(zdt)); // 2023 3月 10 周五 14:32

        var usFormatter = DateTimeFormatter.ofPattern("E, MMMM/dd/yyyy HH:mm", Locale.US);
        System.out.println(usFormatter.format(zdt)); // Fri, March/10/2023 14:32
    }
}
```
